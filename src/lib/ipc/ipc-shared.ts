...
export type RequestChannels = {
  ...
  "show-certificate-trust-dialog": (certificate: Electron.Certificate, message: string) => void
  "get-app-menu": () => void
  ...
  "certificate-error": (certificate: Electron.Certificate, error: string, url: string) => void
  "focus": () => void
  "blur": () => void
...
export type RequestResponseChannels = {
  ...
  "show-save-dialog": (options: Electron.SaveDialogOptions) => Promise<string | null>
  "show-open-dialog": (options: Electron.OpenDialogOptions) => Promise<string | null>
